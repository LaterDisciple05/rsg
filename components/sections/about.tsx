    ...
    <section id="about" className="bg-white py-20 sm:py-24">
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_0.95fr] lg:items-center">
          <div>
            <p className="rsg-section-kicker">About Rising Sun Global</p>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-rsg-muted">
              Rising Sun Global works around scrap procurement, industrial metal
              recovery, recycling, and export-focused supply. The website should
              create trust quickly, then guide serious visitors toward a direct
